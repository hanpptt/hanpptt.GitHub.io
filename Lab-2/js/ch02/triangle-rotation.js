...
function triangle( a, b, c ){
	points.push( a[0]*cos_theta-a[1]*sin_theta, a[0]*sin_theta+a[1]*cos_theta, a[2] );//把所有定点的信息都放入points
	points.push( b[0]*cos_theta-b[1]*sin_theta, b[0]*sin_theta+b[1]*cos_theta, b[2] );
    
    points.push( b[0]*cos_theta-b[1]*sin_theta, b[0]*sin_theta+b[1]*cos_theta, b[2] );
    points.push( c[0]*cos_theta-c[1]*sin_theta, c[0]*sin_theta+c[1]*cos_theta, c[2] );

    points.push( c[0]*cos_theta-c[1]*sin_theta, c[0]*sin_theta+c[1]*cos_theta, c[2] );
    points.push( a[0]*cos_theta-a[1]*sin_theta, a[0]*sin_theta+a[1]*cos_theta, a[2] );
}
